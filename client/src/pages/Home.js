...
export default function Example() {
  ...
  const apiCall = (x) => {
    // x is a string "easy" or "hard"
    const hardWords = async function () {
      // hard mode API call
    ...
    const easyWords = async function () {
      // hard mode API call
        ...
        <div className="col-9">
          {timesUp ? (
            <div>
              ...
              <div className="py-2">
                <InputGroup onChange={testInput} className="input-words">
                  <FormControl
                    defaultValue={value}
                    placeholder={holder}
                    aria-label={holder}
